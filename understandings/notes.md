...
# Case study: BWARS
Do a case study with BWARS as the example. Walk through how the geographic limit was picked, the temporal limit, the unversioned types etc
...
> - Can never transfer 'backward' when there's a mistake